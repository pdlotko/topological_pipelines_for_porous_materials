...
int main( int argc , char** argv )
{
	...
	std::cout << "(2) (double) - number of points per surface area. Set to 0.5 by default. \n";
	...
	if ( argc >= 3 )
	{
		how_many_points_per_surface_area = atof( argv[2] );
	}
	if ( argc >= 4 )
	{
	...
	std::cout << "Number of points iniially sampled from zeo++ : " << initial_number_of_points_sampled_from_zeopp << std::endl;
